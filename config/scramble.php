...
return [
    ...
    /*
     * Use `elements` for Swagger-like "Try it" requests in the browser.
     * Redoc is read-only and cannot submit API requests.
     */
    'renderer' => 'elements',

    'renderers' => [
        /*
         * Stoplight Elements — Swagger-like UI with "Try it" request execution.
         * @see https://docs.stoplight.io/docs/elements/b074dc47b2826-elements-configuration-options
         */
        'elements' => [
            'view' => 'scramble::docs',
            'theme' => 'light',
