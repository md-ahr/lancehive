...
return [
    ...
    */
    ...
    'package_freshness' => [
        ...
        'whitelist' => [
            ...
            // First-party / direct production dependencies (intentionally pinned).
            'dedoc/scramble',
            'resend/resend-php',

            // Transitive production dependencies (Cashier → Stripe, framework → Monolog).
            'monolog/monolog',
            'stripe/stripe-php',

            // Dev tooling (composer require-dev).
            'laravel/boost',
            'laravel/mcp',
            'laravel/pint',
        ],
    ...
    */
    ...
    'suspicious_autoload' => [
        'whitelist' => [
            // Laravel first-party helpers (framework-adjacent packages).
            'laravel/agent-detector',
            'laravel/pao',
            'laravel/prompts',

            // Test stack (Pest, PHPUnit, Mockery, Collision).
            'mockery/mockery',
            ...
            // Production integrations with legitimate autoload.files helpers.
            'resend/resend-php',
            'stripe/stripe-php',

            // Symfony / utility packages (standard helper files).
            'myclabs/deep-copy',
            'psy/psysh',
            'symfony/clock',
            'symfony/string',
